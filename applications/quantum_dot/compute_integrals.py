...
import basis.harmonic.analyticals as ha
from basis.harmonic.util import integral_1b, integral_2b
...
print "Building ",name
hp.writeFunc(name,v1x,bpars,caps,mcpoints,fdir="../../data/harmonic/", integrator=integral_1b,
...
print "Building ",name
hp.writeFunc(name,v1y,bpars,caps,mcpoints,fdir="../../data/harmonic/",integrator=integral_1b,
...
print "Building ",name
hp.writeFunc(name,v2,bpars,caps,mcpoints,fdir="../../data/harmonic",integrator=integral_2b,
             iszero=v2_zeros, analytical=v2_analytical)
